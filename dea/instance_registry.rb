...
module Dea
  class InstanceRegistry
    ...
    def reap_orphaned_crashes
     # logger.debug2("Reaping orphaned crashes --zhang commented for logs")
    ...
    def reap_crashes
     # logger.debug2("Reaping crashes --zhang commented for logs")
    ...
    def reap_crashes_under_disk_pressure
       #logger.debug2("Reaping crashes under disk pressure --zhang commented for logs")
